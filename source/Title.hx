...
class Title extends FlxState
{
    ...
    override public function create()
    {
        ...
        FlxTween.tween(red.scale, {y:0}, 2).onComplete = function(t:FlxTween)
        {
            ...
            start_text = new ZBitmapText(16, 200, ' ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.:/%?!,"-_+=()@', FlxPoint.get(7, 7), 'assets/images/alphabet.png', FlxTextAlign.CENTER, Std.int(FlxG.width - 32));
